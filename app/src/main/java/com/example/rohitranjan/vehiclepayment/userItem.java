...
public class userItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        id = i.getStringExtra(userCategory.ITEM_ID);
    ...
    private void showAddCart(final String itemId, final String itemName, final String imageUrl,
        ...
        addToCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(userItem.this, displayInteger.getText().toString(), Toast.LENGTH_SHORT).show();
                mDataCartRef = FirebaseDatabase.getInstance().getReference(CART_DATABASE_PATH);
