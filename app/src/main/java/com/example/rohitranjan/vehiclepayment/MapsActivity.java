...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //new GetDirectionsData(this).execute();
    ...
    private class GetDirectionsData1 extends AsyncTask<Object,String,String> {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        new AlertDialog.Builder(MapsActivity.this)
                                .setTitle("Payment")
                                .setMessage("Please pay before reaching toll plaza")
                                .setPositiveButton("Start", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent intent = new Intent(getApplicationContext(), PayNow.class);
                                        intent.putExtra("url", "http://p-y.tm/Wg4N-Ub");
